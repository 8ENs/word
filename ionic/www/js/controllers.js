...
//           $("#top").empty();
//         if (pin.status == 'saved') {
//           $("#top").append("<b>MSG: " + pin.message + " | FROM: " + pin.wUser.firstname + " | TYPE: " + pin.type + " | STATUS: " + pin.status + " | DIST: " + Math.round(dist.distance) + "</b>");
//           // var pin_formatted =
...
//           $("#top").append("<b>You are close enough! Touch the pin to open.</b>");
//         } else {
//           $("#top").append("<b>You need to be " + (distToPin - 250) + " m closer to open this pin!</b>");
//         }
//       });
//     });
//   }
